...
const CreateCourseModule = () => {
  return (
    <main className="flex container mx-auto mb-20 lg:mt-2 max-w-[300px] sm:max-w-[400px] md:max-w-[610px] lg:max-w-[700px] xl:max-w-full 2xl:max-w-[1440px] ">
      ...
      <section className='flex flex-col flex-wrap lg:-mt-4 xl:flex-nowrap mx-auto max-w-full xl:max-w-[970px] 2xl:max-w-6xl 3xl:max-w-7xl space-y-7 md:space-y-12 ">'>
        ...
        <div className="flex flex-col md:flex-row md:space-x-7 gap-3 md:gap-8">
        ...
        <div className="flex flex-col md:flex-row justify-between gap-3 md:gap-8">
          <label htmlFor="takeaways" className="flex w-[180px] xl:w-[280px] font-medium text-[#1E1E1E]  font-Inter text-left text-sm leading-5">
            Key takeaways
          </label>
          <div className="w-full md:w-[512px] flex flex-col sm:gap-3">
            <div className="flex flex-col sm:flex-row">
        ...
        <div className="flex flex-col md:flex-row justify-between gap-3 md:gap-8">
          <label htmlFor="details" className="flex w-[180px] xl:w-[280px] font-medium text-[#1E1E1E]  font-Inter text-left text-sm leading-5">
            Module Details
          </label>
          <div className="w-full lg:w-[512px] flex flex-col sm:gap-3">
            <div className="flex flex-col sm:flex-row">
              <span className="flex w-[240px] flex-col">
