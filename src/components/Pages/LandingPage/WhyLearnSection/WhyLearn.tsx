  ...
  return (
    <ul className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 2xl:flex flex-col xl:flex-row font-SFPro animate-slideside300 opacity-0 mx-auto gap-7 ">
      {textElements.map((text, id) => (
        <li
          key={id}
          className={`flex mx-auto p-6 items-start gap-6 md:gap-8 border-[1px] md:border-[0.5px] rounded-lg ${text.borderStyle} ${text.positionStyle} ${text.hoverStyle}`}
        >
          <div className={`flex flex-col gap-3 items-start ${text.titleColor}`}>
            <div className="text-base md:text-xl font-bold leading-[26px]">
              {text.title}
            </div>
            <div className="text-[#212121] hover:text-white text-sm md:text-xl md:text-wrap font-[274] leading-6 md:leading-8">
              {text.description}
            </div>
          </div>
        </li>
...
const textElements: WhyLearnProps[] = [
  {
    ...
    titleColor: "text-[#4588EC] hover:text-white",
    hoverStyle: "hover:bg-[#4588EC]",
  ...
  },
  {
    ...
    titleColor: "text-[#9747FF] hover:text-white",
    hoverStyle: "hover:bg-[#9747FF]",
    description:
  ...
  },
  {
    ...
    titleColor: "text-[#1FAF38] hover:text-white",
    hoverStyle: "hover:bg-[#1FAF38] ",
    positionStyle:
