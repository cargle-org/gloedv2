...
const CourseAsideDetails: React.FC<{ hasPaid: boolean }> = ({ hasPaid }) => {
  ...
  const { sendRequest, status, data: classDetails } =
        ...
        <div className='flex justify-center items-center flex-col'>
          ...
          {!hasPaid && (
            <div className='flex justify-start flex-col h-full gap-3.5 p-5 pb-7 mt-5 w-[290px] lg:w-[332px] text-base font-Inter font-bold bg-white drop-shadow-xl rounded-md leading-[18px]'>
              ...
              <Link to="https://join.slack.com/t/gloedworkspace/shared_invite/zt-yvcwllf9-7Hab2o2DCJl7iifv78lvQ" className='flex items-center gap-3.5 h-[38px] w-[245px] transform transition hover:underline hover:underline-offset-4 hover:text-primary hover:-translate-y-0.5 focus:outline-none focus:ring focus:ring-offset-0'>
                <TbCube className="h-4 w-4" />
