...
const DashboardCards: FC<{ firstName: string }> = (props) => {
  return (
    <section>
      ...
      <div className="grid container 2xl:max-w-[630px] mx-auto gap-4 items-start sm:max-w-full sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-2 2xl:grid-cols-3 2xl:mx-0">
