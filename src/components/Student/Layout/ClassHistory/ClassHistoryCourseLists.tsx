  ...
  return (
    <section className="mb-10 2xl:mr-6">
      ...
      <ul className=" flex flex-wrap w-auto justify-center xl:grid grid-cols-2 xl:grid-cols-3 md:max-w-auto 2xl:max-w-full gap-5 md:gap-4 md:gap-y-7 lg:gap-8 xl:gap-12 3xl:gap-14">
        {(courseLists as ClassHistoryCourseListsProps[])
          ?.slice(0, 3)
          .map((course, index) => (
            <Card
              variant="course"
              key={index}
              className="flex sm:flex-grow w-[280px] sm:w-auto sm:min-w-[280px] sm:max-w-[324px] md:max-w-[290px] lg:max-w-[324px] items-center"
            >
