...
const Button: React.FC<ButtonProps> = (props) => {
  ...
  const btnLandingPage = `${props.style} justify-center px-4 py-2 md:px-6 md:py-3 bg-primary rounded-lg leading-normal hover:bg-primary-light focus:ring-primary-dark focus:ring-opacity-50 active:bg-primary-dark`;
  const btnOptions =
