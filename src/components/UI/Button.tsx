...
const Button: React.FC<ButtonProps> = (props) => {
  ...
  const btnPrimary = 'justify-center font-plus-jakarta-sans px-6 py-3 text-white text-sm sm:text-base font-semibold bg-primary rounded-4xl leading-6 tracking-[-0.32px] hover:bg-primary-light focus:ring-primary-dark focus:ring-opacity-50 active:bg-primary-dark';
  ...
  const btnDark = 'items-center justify-center border border-black py-1.5 sm:py-2.5 px-2 sm:px-4 lg:px-3.5 shadow-sm shadow-[#100e280d] rounded-lg bg-black font-Inter text-base lg:text-sm xl:text-base font-semibold leading-6 text-white focus:ring-black '
  const btnModal = 'justify-center rounded-[5px] py-3 px-4 xl:py-3 xl:px-6 text-white items-center font-Roboto font-bold gap-2 text-sm leading-normal hover:bg-primary-light'
  ...
  const btnAuth = ' rounded-lg justify-center items-center py-2.5 px-[18px] text-white font-Inter font-medium text-base leading-6 hover:bg-primary-light';
