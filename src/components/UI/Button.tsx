...
const Button: React.FC<ButtonProps> = (props) => {
  const btn = 'flex items-center text-center text-nowrap transform transition hover:-translate-y-0.5 focus:outline-none focus:ring focus:ring-offset-0 disabled:opacity-50 disabled:cursor-not-allowed';
