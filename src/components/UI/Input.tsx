...
const Input = (props: InputProps) => {
  ...
  // const inputModal = "flex w-full md:max-w-[352px] h-10 px-3.5 py-2.5 filter drop-shadow-sm border border-[#1E1E1E59] shadow-sm shadow-[#42506666] focus:outline-none focus:ring focus:border-primary rounded-[5px]";
